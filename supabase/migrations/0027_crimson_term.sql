/*
  ...
  1. New Data
    ...
    - Add auth identity with proper provider_id
  2. Security
    - Password is pre-hashed for security
    - User has authenticated role
    - Proper auth identity setup with email as provider_id
*/
...
BEGIN
  ...
  IF existing_user_id IS NULL THEN
    ...
    VALUES (
      ...
      'test@westotel.com',
      '$2a$10$Nq.d6E0LZgMZ/MPyEIhxaOqKkY3.b48GUPp2K8cFZhzXhO2mlJvwW', -- pre-hashed 'test123'
      now(),
    ...
    INSERT INTO auth.identities (
      ...
      'email',
      'test@westotel.com',  -- Use email as provider_id for email provider
      now(),
      now(),
      now()
    );
